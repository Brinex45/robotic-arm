...
#define chooseButton_1 B11110011  //choose the button which needs to be used;  0: not to be used; 1: to be used
...
#define buttonMode_1   B11000011  // 0: on press; 1: on click
...
#define printData_1    B11110011  // choose which button data to be printed
#define printData_2    B01101100  // choose which button data to be printed
int bytesToSend =      0;
int l2, r2, diff;
int val;
